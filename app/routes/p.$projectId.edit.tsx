...
export default function EditProject() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="border-b pb-6">
                <h3 className="text-lg font-bold text-blue-700 mb-2">{t("advancedTab.exportProjectTitle")}</h3>
                <p className="text-sm text-gray-600 mb-4">{t("advancedTab.exportProjectDesc")}</p>
                {cards.length === 0 ? (
                  <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 px-4 py-3 rounded text-sm mb-4">
                    {t("advancedTab.noCardsToExport")}
                  </div>
                ) : null}
                <button
                  type="button"
                  onClick={() => {
                    ...
                    toast.success(t("advancedTab.projectExported"));
                  }}
                  disabled={cards.length === 0}
                  className="flex items-center gap-2 px-6 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
                  <FileDown className="w-4 h-4" /> {t("advancedTab.exportProjectButton")}
                </button>
              </div>
      ...
      {/* Delete Project Modal - moved to global layout */}
      {/* <DeleteProjectModal
