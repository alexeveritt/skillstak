        ...
        <TabsContent value="advanced">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
              <Trash2 className="w-5 h-5 text-red-600" /> Advanced
            </h2>
            <div className="space-y-6">
              ...
              <div className="flex gap-4 mb-6">
                ...
                >
                  <FileDown className="w-4 h-4" /> Export Cards
                </Link>
                <Link
                ...
                >
                  <FileUp className="w-4 h-4" /> Import Cards
                </Link>
              </div>
              {/* Delete Project Section */}
              <div className="border-t pt-6 mt-6">
                <h3 className="text-lg font-bold text-red-700 mb-2">Delete Project</h3>
                <p className="text-sm text-gray-600 mb-4">
                  Deleting this project will permanently remove all cards and cannot be undone.
                </p>
                <Form method="post">
